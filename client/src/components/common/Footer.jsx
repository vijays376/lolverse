...
const Plans = ["Paid memberships", "Discounts", "Coupon Code"];
const Community = ["Forums", "Chapters", "Events"];

export const Footer = () => {
  return (
    <div className="bg-richblack-800 mt-16 ">
      <div className='w-full border-y border-slate-300'>

      </div>
      <div className="ml-10 flex lg:flex-row gap-8 items-center justify-between max-w-maxContent text-richblack-400 leading-6 mx-auto relative py-6">
      ...
      <div className="flex flex-row items-center justify-between w-11/12 max-w-maxContent text-richblack-400 mx-auto  pb-14 text-sm">
        ...
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          ...
          <div className="text-center font-medium">Made with ❤️ Vijay Chouhan © 2024 LOLVerse</div>
        </div>
      </div>
    </div>
  );
